/*3.0.0 model z MP.model (mpLadunek); kopiowanie nalezy do mpKopiujListe*/(function(){var Q=function(s){return document.querySelector(s)};
...
function start(){R=window.MP&&window.MP.przepis;M=window.MP&&window.MP.model;
if(!R||!R.naPorcje||!M||!M.skladniki||!M.skladniki.length)return false;
P=M.porcjeBazowe||2;L.setAttribute('aria-live','polite');if(H)H.hidden=true;
kl('[data-mp-porcje-minus]',-1);kl('[data-mp-porcje-plus]',1);
rys();window.mpSkladniki='3.0.0';return true}
